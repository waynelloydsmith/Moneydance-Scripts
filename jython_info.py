...
"""
os.File java.io.File
os.curdir .
os.environ {}
os.error exceptions.OSError
os.getcwd <unbound method ?.getcwd>
os.initModule <java function initModule at 21505804>
os.java <java package java at 7476959>
os.javapath <module javapath at 29948869>
os.listdir <unbound method ?.listdir>
os.makedirs <unbound method ?.makedirs>
os.mkdir <unbound method ?.mkdir>
os.name java
os.pardir ..
os.path <module javapath at 29948869>
os.pathsep :
os.remove <unbound method ?.remove>
os.rename <unbound method ?.rename>
os.rmdir <unbound method ?.rmdir>
os.sep /
os.stat <unbound method ?.stat>
os.unlink <unbound method ?.remove>
"""
