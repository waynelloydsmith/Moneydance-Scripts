...
url = 'https://www.stockwatch.com/Quote/Download.aspx?type=date&format=ascii&dest=file&exopt=N&ex=I&ats=N&id=' + UserName + '&pw=' + PassWord
...
try:
  response = opener.open(url)
    ...
    if hasattr(e, 'reason'):
        print '46 We failed to reach a server.'
        print '47 Reason: ', e.reason
    if hasattr(e, 'code'):
        print '49 The server couldn\'t fulfill the request.'
        print '50 Error code: ', e.code
else:  
  print '52 responce ', response.headers
